        ...
        <div class="collapse navbar-collapse Navigation" id="navbarSupportedContent">
            <ul>
                ...
                if (isset($_SESSION['id_user'])) {
                    if (admin($_SESSION['id_user']) == true) {
                ?>
                        <li class="nav-item <?php if (isset($_REQUEST['pg']) && ($_REQUEST['pg'] == md5('admin'))) echo 'active'; ?>">
                            <a href="../controler/index.php?pg=<?php echo md5('admin') ?>">Admin</a>
                            <span class="menu-item-bg"></span>
                        </li>
                <?php
                    }
